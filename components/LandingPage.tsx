  ...
  return (
    <div className="dark">
      ...
      <div className="hanken-font bg-[#0b1326] text-[#dae2fd] antialiased min-h-screen flex flex-col relative overflow-x-hidden selection:bg-[#4be277]/30 selection:text-white">
        ...
        {/* --- NAVIGATION --- */}
        <nav className="fixed top-0 left-0 w-full z-50 flex justify-between items-center px-4 sm:px-6 md:px-12 py-2.5 md:py-3 bg-[#0b1326]/90 backdrop-blur-md border-b border-white/10">
          <a className="flex items-center group shrink-0" href="#" aria-label="IziSchool AI">
            <img
              src="/logo.png"
              alt="IziSchool AI"
              className="h-10 sm:h-11 md:h-12 w-auto object-contain transition-transform group-hover:scale-105 drop-shadow-[0_2px_10px_rgba(75,226,119,0.2)]"
            />
          </a>
        ...
        {/* --- MAIN CONTENT --- */}
        <main className="flex-grow z-10 relative pt-[80px] sm:pt-[84px] md:pt-[88px]">

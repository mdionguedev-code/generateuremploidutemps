  ...
  return (
    <div className="dark">
      ...
      <div className="hanken-font bg-[#0b1326] text-[#dae2fd] antialiased min-h-screen flex flex-col relative overflow-x-hidden selection:bg-[#4be277]/30 selection:text-white">
        ...
        {/* --- MAIN CONTENT --- */}
        <main className="flex-grow z-10 relative mt-[64px] md:mt-[72px]">
          
          {/* HERO SECTION */}
          <section className="pt-4 sm:pt-6 md:pt-8 pb-16 md:pb-24 px-6 md:px-12 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
